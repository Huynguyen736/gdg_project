...
class member_list extends StatefulWidget {
  const member_list({super.key, required this.branch});
  final String branch;

  @override
  State<member_list> createState() => _memberlistState();
}

class _memberlistState extends State<member_list> {
                    ...
                    trailing: Row(
                      ...
                      children: [
                        IconButton(onPressed: () {
                              ...
                              }, icon: const Icon(EvaIcons.edit), splashRadius: 24,),
                        IconButton(onPressed: () {deleteContact(contactID);}, icon: const Icon(EvaIcons.person_delete)),
                      ],
                    ),
                  ),
                );
